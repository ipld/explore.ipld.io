  ...
  return (
    <header className='flex-l items-center pa3 bg-navy bb bw3 border-aqua tc tl-l'>
      ...
      <div className="btn-group" className='ph2 ph3-l'>
        <button onClick={handleOnChange} value="cid" className="f6 pointer dim br2 ba ph3 pv2 mb2 dib navy" style={{ border: '0px', backgroundColor: '#69c4cd', borderRight: '1px solid #0b3a53', marginTop: '5px', borderRadius: '5px 0px 0px 5px' }} aria-current="page">CID</button>
        <button onClick={handleOnChange} value="car" className="f6 pointer dim br2 ba ph3 pv2 mb2 dib navy" style={{ border: '0px', backgroundColor: '#69c4cd', marginTop: '5px', borderRadius: '0px 5px 5px 0px'}} aria-current="page">CAR</button>
      </div>
